...
B<-c> as a decimal integer 0-255. The command byte can be followed by
...
B<-r> read byte, 16-bit word or 32-bit words from PIC
...
0x60 stop and remove timer command

0x61 start timer command

0x62 0xNNNNNNNN set counting down time and mode

0x63 0xNNNNNNNN set timer command and up to three parameter bytes

=head1 EXAMPLE

Test i2c communication 

B<pipic> B<-a> 38 B<-c> 2 B<-d> 1375211866W B<-r> W

Set GPIO5 output to "1", chip address 0x26 (or 38) and command 0x25 (or 37)

B<pipic> B<-a> 38 B<-c> 37 
...
B<pipic> B<-a> 38 B<-c> 1 B<-d> 3b B<-r> b

Read analog voltage from AN0

B<pipic> B<-a> 38 B<-c> 64 B<-r> w
